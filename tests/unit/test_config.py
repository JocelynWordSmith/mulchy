...
REQUIRED_PRESET_KEYS = {
    ...
    "FEATURE_SMOOTHING",
    "FX_REVERB_ENABLED", "FX_REVERB_ROOM_SIZE", "FX_REVERB_WET",
    "FX_CHORUS_ENABLED", "FX_CHORUS_RATE", "FX_CHORUS_DEPTH", "FX_CHORUS_MIX",
    "FX_COMPRESSOR_ENABLED", "FX_COMPRESSOR_THRESHOLD", "FX_COMPRESSOR_RATIO",
}
